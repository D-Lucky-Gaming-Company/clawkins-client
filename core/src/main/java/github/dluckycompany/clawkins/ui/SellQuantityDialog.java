...
/**
 * HIGH-FIDELITY MODAL SELL DIALOG
 * 
 * A modern, theme-consistent "Sell Quantity" dialog featuring:
 ...
 */
public class SellQuantityDialog extends Dialog {
    // ============================================================
    ...
    private final int sellPricePerItem;
    ...
    public SellQuantityDialog(Item item, int currentQuantity, int sellPricePerItem, Skin skin, 
                            TextureRegionDrawable minusDrawable,
                            TextureRegionDrawable plusDrawable,
                            TextureRegionDrawable exitDrawable) {
        super("Sell " + item.getName(), createWindowStyle(skin));
        this.item = item;
        ...
        if (retrievedFont == null) {
            Gdx.app.error("SellQuantityDialog", "FATAL: Font is null after safe access, creating fallback");
    ...
    @Deprecated
    public SellQuantityDialog(Item item, int currentQuantity, int sellPricePerItem, Skin skin) {
        this(item, currentQuantity, sellPricePerItem, skin, null, null, null);
    }
    ...
    private void buildUI() {
        ...
        // ============================================================
        // INFO LABEL (Shows sell summary with price)
        // ============================================================
        infoLabel = new Label("Sell: 1x " + item.getName(), new Label.LabelStyle(font, TEXT_PRIMARY));
        ...
        // Total price label
        totalPriceLabel = new Label("Total: " + sellPricePerItem + " gold", new Label.LabelStyle(font, TEXT_PRIMARY));
    ...
    private void updateQuantityLabel() {
        Gdx.app.log("SellQuantityDialog", "Quantity changed to: " + selectedQuantity);
        quantityLabel.setText(String.valueOf(selectedQuantity));
        if (infoLabel != null) {
            infoLabel.setText("Sell: " + selectedQuantity + "x " + item.getName());
        }
        if (totalPriceLabel != null) {
            int totalPrice = selectedQuantity * sellPricePerItem;
